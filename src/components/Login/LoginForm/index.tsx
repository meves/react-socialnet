...
import { Input, Checkbox } from 'components/common/FormControls';
...
import { Button, CheckboxUI, InputUI } from 'shared/ui';
import styles from 'components/common/FormControls/index.module.scss';
